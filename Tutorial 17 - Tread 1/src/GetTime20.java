...
public class GetTime20 extends Thread{
	...
	public void run(){
		...
		for(int i = 1; i <= 10; i++){
			...
			// getDateInstance only outputs date information
...
//			we must wrap any type use of the sleep method which is part of the thread class 
//			inside of try block so that we can handle any errors thrown
			try {
				Thread.sleep(2000);
			}

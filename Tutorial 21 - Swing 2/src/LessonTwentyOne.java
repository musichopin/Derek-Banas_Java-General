...
// imported (package as a whole) in order to handle the even handling
import java.awt.event.*;

// Extends JFrame so it can create frames

public class LessonTwentyOne extends JFrame{
//	All objects don't have to be initialized until they are ready to be used in Java
	JButton button1;
...
//		You'll have a listener for each button normally﻿
		ListenForButton lForButton = new ListenForButton();
		
		// Tell Java that you want to be alerted when an event
		// occurs on the button
//		button1.addActionListener(lForButton); says that when an event 
...
//		java refers to frame as window time to time
...
//		panelin önceden frame eklenmesi önemli değil

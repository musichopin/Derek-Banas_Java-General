...
//	allows us to create a list of items that then will be editable
...
//		(setvisiblerowcount dediðimiz için)
		...
		// If we add scroller, we add the scroll bar container, not the list
		...
		private class ListenForButton implements ActionListener{
			...
			public void actionPerformed(ActionEvent e){
				...
				if(e.getSource() == button1){
					...
					infoOnComponent += "Element in index 0 " + defListModel.get(0) + "\n";

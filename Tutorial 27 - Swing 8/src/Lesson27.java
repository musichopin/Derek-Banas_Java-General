...
//	root node
	...
	public Lesson27(){
		...
		// Create the JTree by passing it the top tree node which contains children nodes 
		...
		// We first add the documents parent node under the root node
...
//				Enumeration enumValue = theFile.children(); 

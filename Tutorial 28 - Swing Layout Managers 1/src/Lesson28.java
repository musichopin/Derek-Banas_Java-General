...
// default is flowlayout and lays side by side
...
//		the difference from flow layout is that we can also put panels 
//		besides components in different positions
...
//		thePanel.setLayout(new BorderLayout());
		...
		/*
		// in different parts it is okay though:
		thePanel.add(button1, BorderLayout.NORTH);

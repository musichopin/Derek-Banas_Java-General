...
// ***Main Panel (GridBagLayout) ve Sub-Panel (FlowLayout, BorderLayout, Box) iliþkisini anlamak önemli.
// (ancak sub-panel olmadan da doðrudan main panele eklenebilir)***
...
//		add the component using the method
		addComp(thePanel, nameLabel, 0, 0, 1, 1, GridBagConstraints.EAST, GridBagConstraints.NONE);
//		(JPanel thePanel, JComponent comp, int xPos, int yPos, int compWidth, int compHeight, int place, int stretch)
...
//		2 cols width
		...
		// Create a set of radio buttons and wrap them in a group (box)
//		we create box layout for radio buttons (sub-panel yerine)
		
		Box sexBox = Box.createVerticalBox(); // we wanna create the buttons vertically 
		maleRadio = new JRadioButton("Male");
		femaleRadio = new JRadioButton("Female");
		sexGroup = new ButtonGroup();
		// with ButtonGroup only male or female can be selected
...
//		(JPanel thePanel, JComponent comp, int xPos, int yPos, int compWidth, int compHeight, int place, int stretch)
		...
		JPanel statePanel = new JPanel(); // sub panel
		
		statePanel.setLayout(new FlowLayout(FlowLayout.RIGHT, 10, 0));
...
//		5 in width bc there is lots of components
...
//		gives us focus
	...
	// and then adds it 
//	GridBagLayout is used to define how the component looks on the screen
	
//	add the component using the method
	private void addComp(JPanel thePanel, JComponent comp, int xPos, int yPos, int compWidth, int compHeight, int place, int stretch){
//		anchor and fill are int

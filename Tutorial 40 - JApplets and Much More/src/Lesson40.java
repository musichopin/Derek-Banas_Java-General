...
//		**sonra her birine border ve radio button eklenir**
		...
		// Makes only one radio button can be selected
...
//		**flowlayout içerisine flow layout yerleþtirir**
...
//				* alt: ques1Panel.setVisible(false);* 
...
//				**since we gotta check 1 of the 2 radio buttons URL becomes sth like this: 
//				<html><div><img src=" file:///Users/derekbanas/Documents/workspace3/Java Code/src/ ESFJ .png "/></div></html>**
...
//				*jeditorpane, jscrollpane'e eklenmiþti*
				thePanel.add(scroller);
				
				getResultBut.setVisible(false);
//				* alt: thePanel.remove(getResultBut); *

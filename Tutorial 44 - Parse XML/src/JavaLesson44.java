...
//		***sýrasýyla, document -> nodelist -> node -> element -> nodelist -> 
...
//        		poly and downcasting örneði:
//        		Super x = new Sub(); // or Super x = new Super(); (interface deðil ise)
...
//        		1'den fazla olsaydý for loop kullanýlabilirdi
        		Node networkNode = networkList.item(0);
        		
//        		Convert into an element to gain access to element methods
        		Element networkElement = (Element) networkNode;
//        		*alt: yukarýdaki 2 satýrlýk kod yerine kýsa yol:
...
//				**casting yapýlmadan yazýlabilir: 

		 ...
		 * 
		 * IOException: An I/O operation failed (related to file system)
		 */
...
//		1: (might) give runtime error
		divideByZero(2);
		
//		2: might give runtime error
		System.out.print("\nHow old are you? ");
...
//		3: (might) give compile time error
	 ...
	 * (throws is used to designate that a method can throw an exception. throw is used to throw an exception)
	 * 
